                    ...
                    <div class="modal-body ">
                        <form action="#" method="POST" >
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" value="<%=cedu%>" class="form-control" id="staticEmail" name="cedula" requiered>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="inputPassword" class="col-sm-2 col-form-label"><strong>Nombres</strong></label>
                                <div class="col-sm-10">
                            ...
                            <div class="mb-3 row">
                                <label for="inputPassword" class="col-sm-2 col-form-label"><strong>Apellidos</strong></label>
                                <div class="col-sm-10">
                            ...
                            <div class="mb-3 row">
                                <label for="inputPassword" class="col-sm-2 col-form-label"><strong>Telefono</strong></label>
                                <div class="col-sm-10">
                            ...
                            <div class="mb-3 row">
                                ...
                                <label for="inputSelected" class="col-sm-2 col-form-label"><strong>Especialidad</strong></label>
